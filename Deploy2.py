...
class Real_Test_15(tpqoa.tpqoa):
    ...
    def on_success(self, time, bid, ask):
        ...
        # define stop
        if recent_tick.time() >= pd.to_datetime("17:00").time():
...
if __name__ == "__main__":
    ...
    trader = Real_Test_15(r"C:\Users\Chia W Y\Downloads\Algo\Part4_Materials\Oanda\oanda.cfg", "EUR_USD", "1min", window = 1, units = 100000)
